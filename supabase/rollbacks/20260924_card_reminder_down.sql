-- Rollback de 20260924_card_reminder.sql: volta save_task_card para a versao
-- de 20260923_card_dates.sql e remove as colunas do lembrete.
...
alter table public.tasks
  ...
  drop column if exists reminder_repeat,
